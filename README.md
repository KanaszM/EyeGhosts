...
The game was developed using **Godot v4.4.dev3.official**. An online web version is available on Itch.io and can be played here: [[link]](https://kanaszm.itch.io/ghosts-of-an-eye).
